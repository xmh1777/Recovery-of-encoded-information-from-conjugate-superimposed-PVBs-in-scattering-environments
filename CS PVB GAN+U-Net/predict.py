...
parser.add_argument("--checkpoint", type=str, default='./saved_models/PVBdata/generator_100.pth', help="inference model checkpoint")
...
#open image
for image_name in glob.glob('./PVBdata/test/*.jpg'):
    print(image_name)
